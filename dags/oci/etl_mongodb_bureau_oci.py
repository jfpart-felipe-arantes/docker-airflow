...
def dag_success_alert(context):
    send_slack_message(webhook_url_engineer, slack_msg="ETL Bureau OK")
...
with DAG(
    "etl_mongodb_bureau_oci",
    default_args=default_args,
    description="Load bureau in bucket oci",
    ...
    def load_csv(df):
        ...
        info('Inicio Load')
        df.to_csv("oci://bkt-prod-veritas-silver@grilxlpa4rlr/MONGODB/MONGODB_BUREAU/bureau" + datetimenow + ".csv",sep=",",index=False,storage_options={"config": config})
        info("Enviado")
