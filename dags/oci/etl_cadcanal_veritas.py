...
def dag_success_alert(context):
    send_slack_message(webhook_url_engineer, slack_msg="ETL CADCANAL VERITAS OK")
...
with DAG(
    ...
    def extract_transform():
        ...
        select_query = "SELECT * FROM SGI_TRN.dbo.tb_CadCanal"
    ...
    def load_csv(df):
        ...
        df_parquet.to_parquet("oci://bkt-prod-veritas-bronze@grilxlpa4rlr/SIRSAN/TB_CADCANAL/cadcanal" + datetimenow + ".parquet.gzip", compression='gzip',storage_options={"config": config})
    ...
    def load_adw(df):
        ...
        cursor.execute("truncate table veritas_silver.SIRSAN_TB_CADCANAL")
        ...
        for index,row in df.iterrows():
            try:
                ...
                insert_sql = (
                    "INSERT INTO "
                    + "veritas_silver.SIRSAN_TB_CADCANAL "
                    + "("
                    + lista_colunas
                    + ") "
                    + "VALUES "
